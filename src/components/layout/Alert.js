...
function Alert() {
	...
	return (
		<div
			className={`grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 gap-8 pt-5`}
			style={{ visibility: alert ? "visible" : "hidden" }}>
			<div
				className='flex p-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800'
				role='alert'>
				<svg
